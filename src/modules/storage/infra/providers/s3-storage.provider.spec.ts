...
describe('S3StorageProvider', () => {
  ...
  describe('generateUploadUrl', () => {
    it('should return a presigned upload URL', async () => {
      const mockSignedUrl = 'https://s3.amazonaws.com/my-bucket/key?X-Amz-Signature=abc';
  ...
  describe('generateDownloadUrl', () => {
    it('should return a presigned download URL', async () => {
      const mockSignedUrl = 'https://s3.amazonaws.com/my-bucket/key?X-Amz-Signature=xyz';
      (getSignedUrl as jest.Mock).mockResolvedValue(mockSignedUrl);
